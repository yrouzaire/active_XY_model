...
tmax = 3000 ; dt = determine_dt(T,Var) ; save_every = 50 ; imax = round(Int,tmax/dt/save_every)
...
# mp4(anim,"figures_draft\\film_SM_XY_annihilation.mp4",fps=25)
...
#         plot!(tt2,distance_avg[1:every_plot:end,1,2],line=:dot,c=1)
#         plot!(tt2,distance_avg[1:every_plot:end,1,3],line=:dot,c=2)
#         xlims!((0,1000))
#         ylims!((-1,38))
